      ...
      {activeTab === "compose" && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 space-y-5">
                    ...
                    <button
                      ...
                      className={`py-2 px-3 rounded-xl text-xs font-sans text-center transition-all ${
                        targetAudience === aud.id
                          ? "bg-indigo-600 text-white font-semibold shadow-xs"
                          : "bg-[#080B14] text-slate-400 hover:text-white border border-slate-800"
                      }`}
                    >
                      {aud.label}
                    </button>
            ...
            <div className="p-6 rounded-2xl bg-[#0C101A] border border-slate-800/80 space-y-3">
              <h3 className="text-sm font-bold font-display text-white">
                2. Purpose Tag
              </h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead className="bg-[#080B14] border-b border-slate-800 text-slate-400 font-mono text-[11px] uppercase">
                <tr>
                  <th className="py-3.5 px-4 font-semibold">Purpose Tag</th>
                  <th className="py-3.5 px-4 font-semibold">Title & Announcement</th>
                  <th className="py-3.5 px-4 font-semibold">Target</th>
                  <th className="py-3.5 px-4 font-semibold">Channels</th>
                  <th className="py-3.5 px-4 font-semibold">Status</th>
                  <th className="py-3.5 px-4 font-semibold text-right">Reach / Clicks</th>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-4 max-w-sm">
                          <p className="font-bold text-white text-xs font-display truncate">
                            {b.title}
                          </p>
                        ...
                        {/* Target Audience */}
                        <td className="py-3.5 px-4 font-mono text-xs uppercase text-slate-300">
