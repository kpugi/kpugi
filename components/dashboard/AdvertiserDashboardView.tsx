...
export default function AdvertiserDashboardView({ companyName, data }: AdvertiserDashboardProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 font-sans text-kpugi-ink">
      ...
      {nearExhaustionCampaigns.length > 0 ? (
        <div className="p-4 sm:p-5 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-xs sm:text-sm text-amber-950 font-display">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-indigo-500/10 border border-indigo-500/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-indigo-500/20 text-indigo-600 flex items-center justify-center shrink-0">
              <Clock className="w-5 h-5" />
            </div>
            <div>
              <h2 className="font-bold text-xs sm:text-sm text-indigo-950 font-display">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-blue-500/10 border border-blue-500/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-blue-500/20 text-blue-600 flex items-center justify-center shrink-0">
              <Zap className="w-5 h-5" />
            </div>
            <div>
              <h2 className="font-bold text-xs sm:text-sm text-blue-950 font-display">
          ...
          <Link
            href="/b/campaigns"
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold shrink-0 transition-all"
          >
        ...
        <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-bold text-xs text-emerald-950 font-display block">
          ...
          <span className="text-[10px] font-mono font-bold text-emerald-700 bg-emerald-500/20 px-2.5 py-1 rounded-full shrink-0">
            AUTO-AUDIT ACTIVE
          </span>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="p-6 rounded-3xl bg-white border border-kpugi-border shadow-xs hover:border-slate-300 transition-all flex flex-col justify-between">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-bold text-kpugi-slate uppercase tracking-wider">
              Verified Views
            </span>
            <div className="w-8 h-8 rounded-xl bg-kpugi-blue/10 text-kpugi-blue flex items-center justify-center">
              <Eye className="w-4 h-4" />
            </div>
          </div>
          <div>
            <div className="font-mono font-bold text-3xl sm:text-4xl text-kpugi-ink">
        ...
        <div className="p-6 rounded-3xl bg-white border border-kpugi-border shadow-xs hover:border-slate-300 transition-all flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-2 text-[11px] font-semibold text-kpugi-slate">
        ...
        <div className="p-6 rounded-3xl bg-white border border-kpugi-border shadow-xs hover:border-slate-300 transition-all flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-2 text-[11px] font-semibold text-kpugi-slate font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="p-6 sm:p-8 rounded-3xl bg-white border border-kpugi-border shadow-xs space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-kpugi-border/60 pb-5">
              <div>
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center p-1 rounded-xl bg-slate-100 border border-slate-200 text-xs font-bold">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      filterTab === 'active'
                        ? 'bg-white text-kpugi-ink shadow-2xs font-bold'
                ...
                <Link
                  href="/b/campaigns"
                  className="text-xs font-bold text-kpugi-blue hover:text-blue-700 hidden sm:inline-flex items-center gap-1 shrink-0 ml-1"
                >
                  <span>All</span>
            ...
            {paginatedCampaigns.length > 0 ? (
              <div className="space-y-4">
                {paginatedCampaigns.map((camp) => {
                  ...
                  return (
                    <div
                      key={camp.id}
                      className="p-5 rounded-2xl border border-kpugi-border hover:border-slate-300 bg-slate-50/50 hover:bg-slate-50 transition-all space-y-4 group"
                    >
                      {/* Top row: Format, title, status */}
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0 space-y-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            <span className="px-2 py-0.5 rounded-md bg-kpugi-blue/10 text-kpugi-blue font-mono font-bold text-[10px] uppercase">
                              {camp.ad_format}
                            </span>
                            {camp.campaign_code && (
                              <span className="px-2 py-0.5 rounded-md bg-slate-200/80 text-slate-700 font-mono font-bold text-[10px] uppercase">
                                {camp.campaign_code}
                              </span>
                            )}
                            <span
                          ...
                          <h3 className="font-display font-bold text-sm sm:text-base text-kpugi-ink truncate group-hover:text-kpugi-blue transition-colors">
                            {camp.title}
                          </h3>
                        </div>
                      ...
                      <div className="space-y-1.5">
                        <div className="flex items-center justify-between text-[11px] font-mono">
                          <span className="text-slate-500">
                            Spent: <strong className="text-kpugi-ink">₦{camp.spent_budget.toLocaleString()}</strong>
                          </span>
                          <span className="text-slate-500">
                            Total: <strong className="text-kpugi-ink">₦{camp.total_budget.toLocaleString()}</strong> ({percentSpent}%)
                          </span>
                        </div>
                      ...
                      <div className="flex items-center justify-between pt-1 border-t border-slate-200/60">
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-1 text-xs font-bold text-kpugi-blue hover:underline"
                        >
              ...
              <div className="py-12 text-center rounded-2xl bg-slate-50 border border-dashed border-slate-200 space-y-3">
                <div className="w-12 h-12 rounded-2xl bg-kpugi-blue/10 text-kpugi-blue flex items-center justify-center mx-auto">
                  <Plus className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="font-bold text-sm text-kpugi-ink font-display">No campaigns to display</h3>
            ...
            {displayedCampaignsSource.length > ITEMS_PER_PAGE && (
              <div className="flex items-center justify-between pt-4 border-t border-kpugi-border/60 text-xs font-mono">
                <span className="text-slate-500">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    disabled={safePage <= 1}
                    className="p-2 rounded-xl border border-kpugi-border bg-white text-slate-700 hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                    title="Previous page"
                  >
                    <ChevronLeft className="w-4 h-4" />
                  </button>
                  <span className="px-3 py-1 text-slate-700 font-bold">
                    {safePage} / {totalPages}
                  </span>
                  <button
            ...
            <div className="text-center pt-2">
              <Link
                href="/b/campaigns"
                className="text-xs font-bold text-kpugi-blue hover:underline inline-flex items-center gap-1.5"
              >
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="p-6 rounded-3xl bg-white border border-kpugi-border shadow-xs space-y-5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse" />
                <h2 className="font-display text-base font-bold text-kpugi-ink">
            ...
            {data.recentActivity && data.recentActivity.length > 0 ? (
              <div className="space-y-3.5">
                {data.recentActivity.slice(0, 5).map((activity) => (
                  <div
                    key={activity.id}
                    className="p-3.5 rounded-2xl bg-slate-50/80 border border-slate-100 hover:border-slate-200 transition-all flex items-start gap-3"
                  >
                    ...
                    {activity.creatorAvatarUrl ? (
                      <Image
                        ...
                        width={36}
                        height={36}
                        className="rounded-xl object-cover shrink-0 border border-slate-200"
                      />
                    ) : (
                      <div className="w-9 h-9 rounded-xl bg-kpugi-blue/10 text-kpugi-blue font-mono font-bold text-xs flex items-center justify-center shrink-0">
                    ...
                    <div className="min-w-0 flex-1 space-y-1">
                      <div className="flex items-center justify-between gap-1">
                        <span className="font-mono font-bold text-xs text-kpugi-ink truncate">
              ...
              <div className="py-8 text-center rounded-2xl bg-slate-50/60 border border-dashed border-slate-200 space-y-2">
          ...
          <div className="p-6 rounded-3xl bg-white border border-kpugi-border shadow-xs space-y-4">
            <h2 className="font-display text-base font-bold text-kpugi-ink">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <Link
                href="/campaigns/new"
                className="p-3.5 rounded-2xl bg-slate-50 hover:bg-kpugi-blue hover:text-white border border-kpugi-border hover:border-kpugi-blue transition-all group flex flex-col justify-between space-y-2"
              >
                <div className="w-8 h-8 rounded-xl bg-kpugi-blue/10 group-hover:bg-white/20 text-kpugi-blue group-hover:text-white flex items-center justify-center font-bold transition-colors">
                  <Plus className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="font-bold text-xs text-kpugi-ink group-hover:text-white">
                    New Campaign Brief
                  </h3>
              ...
              <Link
                href="/b/wallet"
                className="p-3.5 rounded-2xl bg-slate-50 hover:bg-slate-900 hover:text-white border border-kpugi-border hover:border-slate-900 transition-all group flex flex-col justify-between space-y-2"
              >
                <div className="w-8 h-8 rounded-xl bg-emerald-500/10 group-hover:bg-white/20 text-emerald-600 group-hover:text-white flex items-center justify-center font-bold transition-colors">
              ...
              <Link
                ...
                className="p-3.5 rounded-2xl bg-slate-50 hover:bg-slate-900 hover:text-white border border-kpugi-border hover:border-slate-900 transition-all group flex flex-col justify-between space-y-2"
              >
                <div className="w-8 h-8 rounded-xl bg-purple-500/10 group-hover:bg-white/20 text-purple-600 group-hover:text-white flex items-center justify-center font-bold transition-colors">
              ...
              <Link
                ...
                className="p-3.5 rounded-2xl bg-slate-50 hover:bg-slate-900 hover:text-white border border-kpugi-border hover:border-slate-900 transition-all group flex flex-col justify-between space-y-2"
              >
                <div className="w-8 h-8 rounded-xl bg-amber-500/10 group-hover:bg-white/20 text-amber-600 group-hover:text-white flex items-center justify-center font-bold transition-colors">
