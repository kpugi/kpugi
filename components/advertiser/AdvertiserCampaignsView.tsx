    ...
    <div className="space-y-8 font-sans">
      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 justify-between">
        ...
        <div className="flex items-center justify-between lg:justify-end gap-2 overflow-x-auto pb-1">
          ...
          <div className="flex items-center bg-slate-100 p-1 rounded-2xl border border-slate-200 shrink-0 ml-1">
            <button
              type="button"
      ...
      {filteredCampaigns.length > 0 ? (
        <div className="space-y-6">
          {statusFilter === 'archived' && (
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 rounded-2xl bg-rose-50 border border-rose-200">
          ...
          {viewMode === 'grid' ? (
                      ...
                      {isArchived ? (
                        <>
                          <button
                            ...
                            className="p-2.5 rounded-xl border border-slate-200 bg-slate-50 text-slate-400 cursor-not-allowed opacity-40 shadow-2xs"
                          >
                          ...
                          <button
                            ...
                            className="p-2.5 rounded-xl border border-rose-200 bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white transition-colors shadow-2xs"
                          >
                        ...
                        <>
                          ...
                          <button
                            ...
                            className="p-2.5 rounded-xl border border-slate-200 bg-white text-slate-600 hover:bg-slate-100 hover:text-amber-700 hover:border-amber-300 transition-colors shadow-2xs"
                          >
            ...
            <div className="space-y-3">
                    ...
                    <div
                      ...
                      className={`rounded-2xl border bg-white overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                        isExpanded
                          ...
                          : 'border-kpugi-border hover:border-slate-300 shadow-2xs'
                      }`}
                    >
                      ...
                      <button
                        ...
                        className="w-full p-3.5 flex items-center gap-3 text-left transition-colors hover:bg-slate-50/70 active:bg-slate-100/70 select-none"
                      >
                        ...
                        {c.cover_image_url || c.requirements?.creative_image_url || c.company_logo ? (
                          ...
                          <div className="w-10 h-10 rounded-xl bg-kpugi-blue/10 text-kpugi-blue font-bold text-sm flex items-center justify-center shrink-0 border border-kpugi-blue/20">
                            📢
                          </div>
                        )}
                        ...
                        <div className="min-w-0 flex-1">
                          <h4 className="font-display font-bold text-xs sm:text-sm text-kpugi-ink truncate leading-snug">
                            {c.title}
                          </h4>
                          ...
                          <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                            ...
                            <span className="text-[9px] font-medium uppercase tracking-wider text-slate-600 bg-slate-100 border border-slate-200 px-1.5 py-0.5 rounded">
                              {c.ad_format}
                            </span>
                          ...
                          <div
                            className={`p-1.5 rounded-lg transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
                              isExpanded
                                ...
                                : 'rotate-0 text-slate-400 bg-slate-100'
                            }`}
                          >
                      ...
                      >
                        <div className="overflow-hidden min-h-0">
                          <div
                            className={`p-3.5 pt-3 border-t border-slate-100 bg-slate-50/60 space-y-3 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                          ...
                          >
                            ...
                            <div className="space-y-1.5 bg-white p-3 rounded-xl border border-slate-200/80 shadow-2xs">
                              <div className="flex items-center justify-between text-xs">
                                <span className="text-slate-500 font-medium">Spent Budget</span>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div className="bg-white p-2.5 rounded-xl border border-slate-200/80 shadow-2xs">
                                ...
                                <div className="flex items-center gap-1.5 mt-0.5">
                                  ...
                                  <span className="font-bold text-xs text-slate-800">{c.creators_count || 0} creators</span>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 pt-1">
                              <Link
                                href={c.status === 'draft' ? `/b/campaigns/new?draftId=${c.id}` : `/b/campaigns/${c.id}`}
                                className="flex-1 py-2.5 bg-slate-900 hover:bg-slate-800 active:scale-[0.99] text-white font-sans text-xs font-bold text-center rounded-xl transition-all shadow-2xs"
                              >
                              ...
                              {isArchived ? (
                                ...
                                <>
                                  ...
                                  <button
                                    ...
                                    onClick={() => setModalState({ campaign: c, mode: 'archive' })}
                                    title="Archive Completed Campaign"
                                    className="p-2.5 rounded-xl border border-slate-200 bg-white text-slate-600 hover:bg-slate-100 hover:text-amber-700 transition-colors shadow-2xs"
                                  >
                                    <Archive className="w-4 h-4" />
                                  </button>
                                </>
              ...
              <div className="hidden md:block overflow-x-auto rounded-3xl border border-kpugi-border bg-white shadow-sm">
                    ...
                    {filteredCampaigns.map((c) => {
                      ...
                      return (
                        <tr key={c.id} className="hover:bg-slate-50/80 transition-colors">
                            ...
                            <div className="flex items-center gap-3">
                              {c.cover_image_url || c.requirements?.creative_image_url || c.company_logo ? (
                                <Image
                                  ...
                                  width={38}
                                  height={38}
                                  className="w-9 h-9 rounded-xl object-cover border border-kpugi-border shrink-0"
                                />
                              ) : (
                                <div className="w-9 h-9 rounded-xl bg-kpugi-blue/10 text-kpugi-blue font-bold text-xs flex items-center justify-center shrink-0 border border-kpugi-blue/20">
                                  📢
                                </div>
                              )}
                              <div className="min-w-0 max-w-xs sm:max-w-sm">
                                <Link
                                  href={c.status === 'draft' ? `/b/campaigns/new?draftId=${c.id}` : `/b/campaigns/${c.id}`}
                                  className="font-display font-bold text-sm text-kpugi-ink hover:text-kpugi-blue transition-colors line-clamp-1 block"
                                >
                                  {c.title}
                                </Link>
                                <div className="flex items-center gap-1.5 mt-1 text-[11px] text-kpugi-slate flex-wrap">
                                  {c.campaign_code && (
                                    <span className={`font-mono text-[9px] font-bold px-1.5 py-0.5 rounded border ${styles.codeBg}`}>
                                      {c.campaign_code}
                                    </span>
                                  )}
                                  <span className="capitalize text-[10px] font-medium bg-slate-100 border border-slate-200 px-1.5 py-0.5 rounded">{c.ad_format}</span>
                                  <div className="flex items-center gap-1">
                                    {channels.map((ch) => renderNetworkIcon(ch))}
                                  </div>
                                </div>
                          ...
                          <td className="py-4 px-3 whitespace-nowrap">
                            <div className="space-y-1 min-w-[140px]">
                              <div className="flex items-center justify-between text-[11px]">
                                <span className="text-slate-500 font-medium">Spent: <strong className="text-slate-800 font-mono">{formatCompactCurrency(c.spent_budget || 0)}</strong></span>
                          ...
                          {/* CPM Rate */}
                          <td className="py-4 px-3 whitespace-nowrap font-mono font-bold text-slate-800">
                            ₦{c.cpm_rate.toLocaleString()} <span className="text-[10px] text-slate-400 font-sans font-normal">/ 1k</span>
                          </td>

                          {/* Creators */}
                          <td className="py-4 px-3 whitespace-nowrap">
                            <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-700 bg-slate-100 px-2.5 py-1 rounded-xl">
                              <Users className="w-3.5 h-3.5 text-slate-500" />
                          ...
                          <td className="py-4 px-4 text-right whitespace-nowrap">
                            <div className="inline-flex items-center gap-1.5 justify-end">
                              <Link
                                href={c.status === 'draft' ? `/b/campaigns/new?draftId=${c.id}` : `/b/campaigns/${c.id}`}
                                className="px-3 py-1.5 bg-slate-900 hover:bg-slate-800 text-white font-sans text-xs font-bold text-center rounded-xl transition-colors shadow-2xs inline-block"
                              >
                                {c.status === 'draft' ? 'Resume Draft →' : isArchived || isCompleted ? 'View Records →' : 'Manage →'}
                              </Link>
                              ...
                              {isArchived ? (
                                <>
                                  <button
                                    ...
                                    disabled
                                    title="Archived campaigns cannot be edited"
                                    className="p-1.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-400 cursor-not-allowed opacity-40 shadow-2xs"
                                  >
                                  ...
                                  <button
                                    ...
                                    onClick={() => setModalState({ campaign: c, mode: 'delete' })}
                                    title="Delete Archived Campaign from Dashboard"
                                    className="p-1.5 rounded-lg border border-rose-200 bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white transition-colors shadow-2xs"
                                  >
                                    <Trash2 className="w-3.5 h-3.5" />
                                  </button>
                                </>
                                ...
                                <>
                                  ...
                                  <button
                                    ...
                                    onClick={() => setModalState({ campaign: c, mode: 'archive' })}
                                    title="Archive Completed Campaign"
                                    className="p-1.5 rounded-lg border border-slate-200 bg-white text-slate-600 hover:bg-slate-100 hover:text-amber-700 hover:border-amber-300 transition-colors shadow-2xs"
                                  >
                                    <Archive className="w-3.5 h-3.5" />
                                  </button>
                                </>
                                ...
                                <>
                                  <button
                                    ...
                                    title={c.status === 'draft' ? 'Continue Creation Wizard' : 'Edit Campaign Details'}
                                    className="p-1.5 rounded-lg border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:text-kpugi-blue transition-colors shadow-2xs"
                                  >
                                    <Pencil className="w-3.5 h-3.5" />
                                  </button>
