  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-kpugi-border shadow-xs space-y-6">
        <div>
            <h2 className="font-display text-xl font-bold text-kpugi-ink mt-1">Primary Account Admin</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-1 flex items-center gap-1">
              <Info className="w-3 h-3 text-kpugi-blue" /> Synchronized across your primary administrator account.
            </p>
          </div>
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-kpugi-border shadow-xs space-y-6">
        <div>
          <h2 className="font-display text-xl font-bold text-kpugi-ink mt-1">Receipt & Tax Settings</h2>
          <p className="text-xs text-slate-500 mt-0.5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-24 py-3.5 rounded-xl border border-slate-200 bg-slate-100 text-xs sm:text-sm text-slate-500 cursor-not-allowed select-none"
              />
              <span className="absolute right-3 top-3 px-2 py-0.5 rounded-lg text-[10px] font-bold bg-white text-slate-600 border border-slate-200 shadow-2xs flex items-center gap-1">
